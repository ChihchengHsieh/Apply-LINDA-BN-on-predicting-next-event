...
class TrainingRecord:
    ...
    def plot_loss(self):
        ...
        plt.plot(self.validation_loss_records, marker='o', label='Validation loss')
        plt.ylabel('Loss', fontsize = 8)
        plt.xlabel('Every %d steps' % (self.record_freq_in_step))
        plt.legend(loc = 'upper left')

    def plot_accuracy(self):
        plt.plot(self.train_accuracy_records, marker='o', label='Training accuracy')
        plt.plot(self.validation_acuuracy_records, marker='o', label='Validation accuracy')
